...
describe('AdminSongsController', (): void => {
  ...
  beforeEach((): void => {
    ...
    const adminSongsService = {
      createSong,
      listSongs,
      getSong,
      updateSong,
      deleteSong,
    } as unknown as AdminSongsService;

    controller = new AdminSongsController(adminSongsService);
  });

  // ── create ─────────────────────────────────────────────────────────────

  describe('create', (): void => {
    it('delegates to adminSongsService.createSong', async (): Promise<void> => {
      const song = makeSong();
  ...
  describe('list', (): void => {
    it('delegates to adminSongsService.listSongs', async (): Promise<void> => {
      const song = makeSong();
  ...
  describe('getById', (): void => {
    it('delegates to adminSongsService.getSong', async (): Promise<void> => {
      const song = makeSong();
  ...
  describe('update', (): void => {
    it('delegates to adminSongsService.updateSong', async (): Promise<void> => {
  ...
  describe('remove', (): void => {
    it('delegates to adminSongsService.deleteSong', async (): Promise<void> => {
