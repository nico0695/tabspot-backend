...
import type { AdminArtistsService } from '../../services/admin-artists.service';
...
describe('AdminArtistsController', (): void => {
  ...
  beforeEach((): void => {
    ...
    const adminArtistsService = {
      createArtist,
      listArtists,
      getArtist,
      updateArtist,
      deleteArtist,
    } as unknown as AdminArtistsService;

    controller = new AdminArtistsController(adminArtistsService);
  });

  // ── create ─────────────────────────────────────────────────────────────

  describe('create', (): void => {
    it('delegates to adminArtistsService.createArtist', async (): Promise<void> => {
  ...
  describe('list', (): void => {
    it('delegates to adminArtistsService.listArtists', async (): Promise<void> => {
      const artist = makeArtist();
  ...
  describe('getById', (): void => {
    it('delegates to adminArtistsService.getArtist', async (): Promise<void> => {
      const artist = makeArtist();
  ...
  describe('update', (): void => {
    it('delegates to adminArtistsService.updateArtist', async (): Promise<void> => {
  ...
  describe('remove', (): void => {
    it('delegates to adminArtistsService.deleteArtist', async (): Promise<void> => {
